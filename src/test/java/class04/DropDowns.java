...
//        so we must add a sleep here
        ...
        // 1. find the element using associate with the dropdown
        WebElement days = driver.findElement(By.xpath("//select[@id='day']"));

        // 2. create an object of the selected class and pass in the parameters the element of the dropdown
        Select sel = new Select(days);

        //3.use method provided in select class to select the option you desire
        sel.selectByVisibleText("8");
        //for observation we will use some time
        Thread.sleep(2000);
